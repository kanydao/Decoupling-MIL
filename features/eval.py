...
#----------------------------------------------------------------------------------------------------------------------------------------#
from baseline_database import Baseline, BaselineMultiCrop
from models import resnet

if args.mode == 'video':
    testset = BaselineMultiCrop(root='data/baseline/', split='val', clip_len=32)
elif args.mode == 'clip':
    testset = Baseline(root='data/baseline/', split='val', clip_len=32)

testloader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size, shuffle=False, num_workers=args.workers)

if args.model=='r50':
    net = resnet.i3_res50(num_classes=400)
