...
class Dataset(data.Dataset):
    def __init__(self, root, is_normal=True, test_mode=False, sampling='random', transform = None):
        ...
        self.normal_root_path_train = os.path.join(root, "train_set_normal")
        self.abnormal_root_path_train = os.path.join(root, "train_set_abnormal")

        self.normal_root_path_test = os.path.join(root, "test_set_normal")
        self.abnormal_root_path_test = os.path.join(root, "test_set_abnormal")
